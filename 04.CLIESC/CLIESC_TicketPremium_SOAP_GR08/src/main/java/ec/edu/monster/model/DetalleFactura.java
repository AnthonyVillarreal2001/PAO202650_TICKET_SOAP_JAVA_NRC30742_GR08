...
public class DetalleFactura {
    ...
    public DetalleFactura(long idDetalle, String codigoPartido, long idFactura, String codigoLocalidad, int cantidad, double precioUnitario, double totalDetalle) {
