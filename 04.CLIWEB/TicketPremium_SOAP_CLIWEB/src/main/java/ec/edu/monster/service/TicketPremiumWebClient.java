...
public class TicketPremiumWebClient {
    ...
    public static List<PartidoFutbol> listarPartidosDisponibles() {
        ...
        try {
            ...
            System.out.println("[SOAP CLIENT] Partidos encontrados: " + nodes.getLength());
            ...
            System.out.println("[SOAP CLIENT] Error parseando respuesta: " + ex.getMessage());
            ex.printStackTrace();
            return partidos;
        }
        return partidos;
    ...
    private static String invokeSoap(String operation, String bodyFragment) {
        ...
        try {
            ...
            try (InputStream in = input; ByteArrayOutputStream out = new ByteArrayOutputStream()) {
                ...
                System.out.println("[SOAP] Response: " + result.substring(0, Math.min(500, result.length())));
                return result;
            }
        } catch (Exception ex) {
            System.out.println("[SOAP ERROR] " + ex.getMessage());
            ex.printStackTrace();
            return "";
        } finally {
            if (connection != null) {
